...
public class BluetoothRCClientGUI {
	...
	private void initialize() {
      ...
      public void actionPerformed(ActionEvent e) {
		...
		JButton btnNewButton_1 = new JButton("autonomer Modus");
      ...
      public void actionPerformed(ActionEvent e) {
		...
		JLabel lblAutonomousMode = new JLabel("in autonomen Modus wechseln");
		lblAutonomousMode.setBounds(12, 158, 328, 14);
		panel_1.add(lblAutonomousMode);
